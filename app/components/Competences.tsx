...
export default function Competences() {
  ...
  const competences: Competence[] = [
    {
      ...
      subtitle: 'Administration avancée et scripting',
      level: 90,
      category: ['systemes']
    },
    {
      ...
      subtitle: 'Active Directory, GPO, WSUS',
      level: 85,
      category: ['systemes']
    },
    {
      ...
      subtitle: 'Gestion de clusters et migrations',
      level: 88,
      category: ['systemes']
    },
    {
      icon: '🛡️',
      title: 'Pare-feu Fortinet',
      subtitle: 'Configuration, règles, VPN',
      level: 92,
      category: ['securite']
    },
    {
      ...
      subtitle: 'Tunnels sécurisés et accès distants',
      level: 87,
      category: ['reseaux', 'securite']
    },
    {
      icon: '🗄️',
      title: 'DNS, DHCP, VLAN',
      subtitle: 'Services réseau essentiels',
      level: 85,
      category: ['reseaux', 'services']
    },
    {
      icon: '⚙️',
      title: 'Routage et Switching',
      subtitle: 'Configuration réseau avancée',
      level: 80,
      category: ['reseaux']
    },
    {
      icon: '🔒',
      title: 'Bastion Wallix',
      subtitle: 'Gestion des accès privilégiés',
      level: 90,
      category: ['securite']
    },
    {
      icon: '🛡️',
      title: 'Fail2ban, Portsentry',
      subtitle: 'Protection contre les intrusions',
      level: 83,
      category: ['securite']
    },
    {
      icon: '🔐',
      title: 'SSL/TLS, GPG',
      subtitle: 'Chiffrement et certificats',
      level: 85,
      category: ['securite']
    },
    {
    ...
    },
    {
      icon: '🗄️',
      title: 'Apache, Nginx',
      subtitle: 'Serveurs web et reverse proxy',
      level: 85,
      category: ['services']
    },
    {
      ...
      subtitle: 'Administration de bases de données',
      level: 80,
      category: ['services']
    },
    {
      icon: '🐳',
      title: 'Docker',
      subtitle: 'Conteneurisation d\'applications',
      level: 78,
      category: ['services']
    },
    {
      ...
      subtitle: 'Versioning et docs techniques',
      level: 88,
    ...
    },
    {
      icon: '💬',
      title: 'Communication',
      subtitle: 'Vulgarisation technique',
      level: 85,
      category: ['soft-skills']
    },
    {
  ...
  const filters = [
    { id: 'all', label: 'Toutes les compétences', icon: '🔧' },
