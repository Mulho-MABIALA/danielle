  ...
  return (
    <section id="contact" className="relative py-32 bg-linear-to-b from-white via-slate-50 to-white dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div
          ref={headerRef}
          className={`text-center mb-16 scroll-reveal scroll-reveal-up ${headerRevealed ? 'revealed' : ''}`}
        >
          ...
          <h2 className="text-5xl md:text-6xl font-bold mb-6">
            <span className="bg-linear-to-r from-red-700 to-green-800 dark:from-slate-200 dark:to-slate-400 bg-clip-text text-transparent">
              Prenons Contact
            </span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div
              ref={infoRef}
              className={`bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-lg border-2 border-slate-100 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 transition-all duration-300 scroll-reveal scroll-reveal-left ${infoRevealed ? 'revealed' : ''}`}
            >
            ...
            >
              ...
              <div className="flex gap-4">
                <a
                  ...
                  className="w-12 h-12 bg-[#0A66C2] hover:bg-[#004182] rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-blue-500/20"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 bg-[#333] hover:bg-[#24292f] rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-slate-500/20"
                >
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div
            ref={formRef}
            className={`bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-lg border-2 border-slate-100 dark:border-slate-700 scroll-reveal scroll-reveal-right ${formRevealed ? 'revealed' : ''}`}
          >
