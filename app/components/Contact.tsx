...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative py-32 bg-gradient-to-b from-white via-slate-50 to-white overflow-hidden">
      {/* Background décoratif */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/4 -right-40 w-96 h-96 bg-slate-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob"></div>
        <div className="absolute bottom-1/4 -left-40 w-96 h-96 bg-slate-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-slate-100 hover:border-slate-300 transition-all duration-300">
              <h3 className="text-2xl font-bold text-slate-800 mb-6">Informations de contact</h3>

              <div className="space-y-6">
                {/* Localisation */}
                <div className="flex items-start gap-4 group">
                  <div className="w-12 h-12 bg-gradient-to-br from-slate-100 to-slate-200 rounded-xl flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform duration-300">
                  ...
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-1">Localisation</h4>
                    <p className="text-slate-600">Limoges, France</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-slate-700 hover:text-slate-900 hover:underline transition-colors break-all"
                    >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 rounded-xl border-2 border-slate-200 focus:border-slate-700 focus:outline-none transition-colors"
