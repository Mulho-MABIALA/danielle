  ...
  return (
    <section id="formations" className="relative py-32 bg-white dark:bg-slate-800 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/4 -left-40 w-96 h-96 bg-slate-100 dark:bg-slate-700 rounded-full mix-blend-multiply filter blur-3xl opacity-30"></div>
        <div className="absolute bottom-1/4 -right-40 w-96 h-96 bg-slate-50 dark:bg-slate-700 rounded-full mix-blend-multiply filter blur-3xl opacity-30"></div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-8">
              <div className="w-12 h-12 bg-slate-800 dark:bg-slate-700 rounded-xl flex items-center justify-center">
            ...
            <div className="space-y-6">
              ...
              <div className="group relative">
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg border-2 border-slate-100 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 hover:shadow-2xl transition-all duration-300 ml-4">
                  <div className="flex items-start justify-between mb-4">
                    <span className="inline-block bg-slate-800 dark:bg-slate-700 text-white text-xs font-bold px-3 py-1 rounded-full">
                      2024 - 2026
                    </span>
                    <div className="flex gap-2">
                      <span className="bg-slate-100 dark:bg-slate-700 text-slate-800 dark:text-slate-200 text-xs font-semibold px-3 py-1 rounded-full">
                        Motivée
                      </span>
                      <span className="bg-slate-200 dark:bg-slate-700 text-slate-800 dark:text-slate-200 text-xs font-semibold px-3 py-1 rounded-full">
                        Travailleuse
                      </span>
                    </div>
                  </div>
              ...
              <div className="group relative">
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg border-2 border-slate-100 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 hover:shadow-2xl transition-all duration-300 ml-4">
                  <div className="flex items-start justify-between mb-4">
                    <span className="inline-block bg-slate-700 dark:bg-slate-600 text-white text-xs font-bold px-3 py-1 rounded-full">
                      2023 - 2024
                    </span>
                    <span className="bg-slate-200 dark:bg-slate-700 text-slate-800 dark:text-slate-200 text-xs font-semibold px-3 py-1 rounded-full">
                      Passionnée
              ...
              <div className="group relative">
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg border-2 border-slate-100 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 hover:shadow-2xl transition-all duration-300 ml-4">
                  <div className="flex items-start justify-between mb-4">
                    <span className="inline-block bg-slate-600 dark:bg-slate-600 text-white text-xs font-bold px-3 py-1 rounded-full">
                      2021 - 2022
                    </span>
                  </div>
                  <h4 className="text-xl font-bold text-slate-900 dark:text-white mb-2">
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="bg-linear-to-br from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-700 rounded-2xl p-6 border-2 border-slate-200 dark:border-slate-700 shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-2">
                    <svg className="w-6 h-6 text-slate-700 dark:text-slate-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222" />
                    </svg>
                    <span className="text-xs font-bold text-slate-700 dark:text-slate-200 bg-slate-100 dark:bg-slate-700 px-3 py-1 rounded-full">
                      Envisagée
                    </span>
                  </div>
                  <span className="bg-slate-700 dark:bg-slate-600 text-white text-xs font-bold px-3 py-1 rounded-full">
                    BAC+3
                  </span>
                </div>
            ...
            <div>
              ...
              {/* Message temporaire */}
              <div className="bg-linear-to-br from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-700 rounded-2xl p-8 border-2 border-dashed border-slate-300 dark:border-slate-600 text-center">
                <div className="w-20 h-20 bg-slate-100 dark:bg-slate-700 rounded-full flex items-center justify-center mx-auto mb-6">
                  <svg className="w-10 h-10 text-slate-700 dark:text-slate-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
