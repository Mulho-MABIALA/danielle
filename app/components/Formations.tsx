...
export default function Formations() {
  ...
  const certBadgeColors = [
    ...
    },
    {
      ...
      topBar: 'bg-linear-to-r from-purple-500 to-indigo-500',
      iconBg: 'bg-linear-to-br from-purple-500 to-indigo-600',
      badgeText: 'text-purple-700 dark:text-purple-400 bg-purple-50 dark:bg-purple-900/20',
      downloadBtn: 'bg-linear-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 hover:shadow-purple-600/25',
      viewHover: 'hover:bg-purple-50 dark:hover:bg-purple-900/20 hover:text-purple-700 dark:hover:text-purple-400',
    },
  ];
  ...
  const certIcons = [
    ...
    <svg key="ci3" className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-8">
              <div className="w-12 h-12 bg-linear-to-br from-blue-800 to-indigo-900 rounded-xl flex items-center justify-center">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
              </div>
              <h3 className="text-3xl font-bold text-slate-900 dark:text-white">{t.formations.cursus}</h3>
            </div>
          ...
          <div className="space-y-8">
            <div ref={rightColReveal.ref} className={`scroll-reveal scroll-reveal-right ${rightColReveal.isRevealed ? 'revealed' : ''}`}>
              <div className="flex items-center gap-3 mb-8">
                ...
                <h3 className="text-3xl font-bold text-slate-900 dark:text-white">{t.formations.poursuite}</h3>
              </div>
